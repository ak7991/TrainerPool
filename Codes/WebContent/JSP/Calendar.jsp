...
<header>
		...
		<c:set var="username" value="${sessionScope.UserName}" > </c:set>
			...
			<div class="dropdown">
			<button href="AdminUtilities?Action=Home" onclick="myFunction()" class="dropbtn"><i class="fas fa-user-circle fa-2x" style="color: white;"></i></button>
			  <br><br>
...
<tr>	
		...
		<td><%= t.gettLname() %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><%= t.gettGender() %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><%= srv.getCIdByTIdAndDates(t.getTrainerId(), t.gettDateOfBegin(),t.gettDateOfEnd()) %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
