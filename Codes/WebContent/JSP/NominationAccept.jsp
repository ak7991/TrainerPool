...
<div class="box" action="UserUtilities">
	...
	<form action="../LandingPage">
		...
		<h5 align="center" style="color: white;font-family: sans-serif;font-weight: 500">You have successfully migrated to a trainer.</h5>
		<h5 align="center" style="color: white;font-family: sans-serif;font-weight: 500">You don't need to signup again as a trainer, please use your SME credentials.</h5>
		<button type="submit" name="Action" value="TrainerReLogin" placeholder="Password" required id="Password" align="center">Trainer Re-Login</button><br>
		<
