...
<!-- Direct Link to a webpage (the index page) [case 3 of 3] -->
<div class="redirection"><a id="link" href="HTML/Index.html" style="color:'white;'"> <h5 align="center" >Redirect to Index page</a></div>
