...
<div class="box" action="LandingPage">
	<c:if test="${sessionScope.PasswordUpdateBoolean}">
	<h4 style="color: white;font-family: sans-serif;font-weight: 500">Your password has been successfully updated revert back to home page.</h4>
	</c:if>
	<c:if test="${!sessionScope.PasswordUpdateBoolean}">
	<h4 style="color: white;font-family: sans-serif;font-weight: 500">Your password could not be changed as you entered the wrong password revert back to home page.</h4>
	</c:if>	
