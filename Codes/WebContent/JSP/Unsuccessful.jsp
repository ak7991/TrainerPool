...
<!-- One of the only cases (case 2 of 3) of redirection to an html page right from the webpage. -->
<form class="box" id="box"  action="HTML/Index.html">
<div class="login">
<input type="submit" name="Login" value="Relogin" width="20%">
</div>
</form>	
<form class="box" id="box"  action="LandingPage">
<div class="signUp">
<input type="submit" name="Action" value="SignUp" width="20%">
</div>
</form>	
<div class="footer">
